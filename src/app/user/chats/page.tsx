      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          ...
          messages.map((message) => (
            ...
            >
              <div
                className={`max-w-xs md:max-w-md rounded-lg px-4 py-2 ${message.sender._id === user?._id ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'}`}
              >
                <div className="flex items-center space-x-2">
                  {message.sender._id !== user?._id && message.sender.photo && (
                    <img
